...
(async () => {
  ...
  console.log('Opening deployed URL for deep checks:', url);
  ...
  if (errors.length) { console.error('Deep deployed UI verification found page errors'); process.exit(2); }
  console.log('\nDeep deployed UI verification completed successfully');
  process.exit(0);
})();
